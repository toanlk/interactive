...
<html lang="en">
<head>
    <title>Code coverage report for src/TimePicker/HourView.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/TimePicker</a> HourView.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  handleChange = <span class="fstat-no" title="function not covered" >(h</span>ours, isFinish) =&gt; {
    const updatedTime = <span class="cstat-no" title="statement not covered" >this.props.date.clone().hour(hours);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.props.onChange(updatedTime, isFinish);</span>
  }
&nbsp;
  render() {
