...
<html lang="en">
<head>
    <title>Code coverage report for src/TimePicker/MinutesView.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/TimePicker</a> MinutesView.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  handleChange = <span class="fstat-no" title="function not covered" >(m</span>inutes, isFinish) =&gt; {
    const updatedDate = <span class="cstat-no" title="statement not covered" >this.props.date.clone().minutes(minutes);</span>
<span class="cstat-no" title="statement not covered" >    this.props.onChange(updatedDate, isFinish);</span>
  }
&nbsp;
  render() {
