...
<html lang="en">
<head>
    <title>Code coverage report for src/_shared/PickerToolbar.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/_shared</a> PickerToolbar.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
const PickerToolbar = <span class="fstat-no" title="function not covered" >(p</span>rops) =&gt; {
  const {
...
const styles = theme =&gt; ({
  toolbar: {
    ...
    backgroundColor: theme.palette.type === 'light'
      ...
      : <span class="branch-1 cbranch-no" title="branch not covered" >theme.palette.background.default,</span>
  },
});
&nbsp;
